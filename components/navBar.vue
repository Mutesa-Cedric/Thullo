<template>
  ...
  <div class=" container border flex items-center justify-between px-12 h-[12vh] w-full bg-white">
    ...
    <div class="flex items-center space-x-3">
      <div class="space-x-8 flex items-center text-heading-1"
        :class="selectedBoard && ' pr-3 border-r border-r-[#E0E0E0]'">
        <!-- logo -->
      ...
      <!-- boards selector -->
      <button v-if="selectedBoard" type="button"
        class="flex items-center p-2 border rounded-lg bg-gray-light hover:border-primary  space-x-2">
    ...
    <div class="flex items-center space-x-8">
      <!-- search -->
      <div class="inp-container bg-white p-1  rounded-lg flex items-center space-x-5 border-2 border-transparent"
        :class="inputActive && 'border-primary'">
        <input type="text"
          class="outline-none placeholder:text-[#BDBDBD] placehoder:font-medium py-2 placeholder:text-sm text-sm text-gray-500 px-3 "
          placeholder="Keyword..." @focus="setInputActive(true)" @blur="setInputActive(false)" />
